...
def create_message(sender, to, subject, message_text):
    ...
    encodedMsg = base64.urlsafe_b64encode(msg.as_bytes()).decode('utf-8')  # Ensure utf-8 encoding
...
def send_email(service, user_id, message_body):
    ...
    Args:
        service: Authorized Gmail API service instance.
        user_id: The user's email address. "me" can be used to indicate the authenticated user.
        message_body: The message object with raw base64-encoded content.
