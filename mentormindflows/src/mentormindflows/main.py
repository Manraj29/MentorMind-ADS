...
def write_file(file_path: str, content: str) -> None:
    ...
    file_path = os.path.join(os.path.dirname(__file__), "../outputs", file_path)
    try:
        tool._run(filename=file_path, content=content)
...
class MentorMindFlow(Flow[MentorMindState]):
    ...
    def trigger_agents(self):
        ...
        print("Study Planner Agent triggered", self.state.agent_response)
        # stringify the response
        self.state.agent_response = str(self.state.agent_response)
        # write the report to file
        write_file("study_plan.md", self.state.agent_response)
        print("Study Planner report written to file")
        ...
        print("Career Guide Agent triggered", self.state.agent_response)
        self.state.agent_response = str(self.state.agent_response)

        # write the report to file
        write_file("career_guide.md", self.state.agent_response)
        print("Career Guide report written to file")
        ...
        print("Peer Comparison Agent triggered", self.state.agent_response)
        self.state.agent_response = str(self.state.agent_response)
        # write the report to file
        write_file("peer_comparison.md", self.state.agent_response)
        print("Peer Comparison report written to file")
